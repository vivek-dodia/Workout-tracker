...
import { selectRecentWorkoutsByQuery, selectWorkoutsByQuery } from "../selectors/workoutSelectors"
...
const Workouts = () => {
  ...
  const recentWorkouts = useAppSelector((state) =>
    selectRecentWorkoutsByQuery(state, searchQuery)
  )
  ...
  return (
    <Page>
      ...
      <Page.Content>
      {!!recentWorkouts.length && <RecentWorkouts />}
